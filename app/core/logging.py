...
def setup_logging(level: int | None = None) -> None:
    ...
    for name in ("app.pipeline.livekit_rooms", "app.pipeline.session_pipeline",
    ...
    # ── TEMP DIAGNOSTIC ──
    lk = logging.getLogger("app.pipeline.livekit_rooms")
    print(
        f"[diag] app.pipeline.livekit_rooms → disabled={lk.disabled} "
