...
from api.v1.endpoints.livekit import router as livekit_router, sse_router
from api.v1.endpoints.privacy import router as privacy_router
from api.v1.endpoints.lkc import router as lkc_router
from api.v1.endpoints.capture import (
    capture_router,
    agent_router,
    ner_router,
    retrieval_router,
...
from api.v1.endpoints.supabase import router as supabase_router
from api.v1.endpoints.websockets import router as ws_router
